...
export const siteConfig = {
  ...
  gallery: [
    ...
    {
      src:    '/images/gallery/family-portrait-five.png',
      alt:    'The Land family with fresh-cut watermelons',
      width:  1024,
      height: 768,
      tag:    'Family',
      title:  'The Land family',
    },
    {
      src:    '/images/gallery/family-portrait-large.png',
      alt:    'Three generations of the Land family with fresh-cut watermelons',
      width:  1024,
      height: 768,
      tag:    'Family',
    ...
    {
      src:    '/images/gallery/melon-on-vine.png',
      alt:    'A Land Pride watermelon ripening on the vine',
      width:  1024,
      height: 768,
      tag:    'Field',
      title:  'Ripening on the vine',
    },
    {
    ...
    {
      src:    '/images/gallery/loading-into-bus.png',
      alt:    'Workers loading watermelons inside a converted hauler',
      width:  1024,
      height: 768,
      tag:    'Harvest',
      title:  'Loading the hauler',
    },
    {
    ...
    {
      src:    '/images/gallery/workers-conveyor.png',
      alt:    'Crew running watermelons onto the conveyor at the packing shed',
      width:  1024,
      height: 768,
      tag:    'Packing',
    ...
    {
      src:    '/images/gallery/packing-house-boxes.png',
      alt:    'Fresh Watermelons cardboard boxes ready for shipping',
      width:  1024,
      height: 768,
      tag:    'Packing',
      title:  'Packed to spec, any pallet',
    },
    {
    ...
    {
      src:    '/images/gallery/crates-on-dock.png',
      alt:    'Watermelon crates lined up on the loading dock',
      width:  1024,
      height: 768,
      tag:    'Shipping',
      title:  'Crates on the dock',
    },
    {
    ...
    {
      src:    '/images/gallery/trucks-loaded-buses.png',
      alt:    'Haulers loaded high with Land watermelons heading out for delivery',
      width:  768,
      height: 1024,
      tag:    'Shipping',
      title:  'Headed for the dock',
    },
  ],
